  ...
  return (
    <Layout>
      <Box m="2rem 5rem">
        ...
        <p>
          The MovieFreak website located at www.moviefreak.com is a copyrighted
          work belonging to MovieFreak. Certain features of the Site may be
        ...
        <p>
          <strong>Third-Party Links and Ads.</strong> The Site may contain links
        ...
        <p>
          ...
          MovieFreak uses 'cookies'. These cookies are used to store information
        ...
        <p>
          ...
          the Company should be sent to: Bulevar Oslobodjenja 3. After the
        ...
        <p>Address: Bulevar Oslobodjenja 3</p>
        <p>Email: moviefreak@hotmail.com</p>
      </Box>
    </Layout>
  );
}
