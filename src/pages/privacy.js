  ...
  return (
    <Layout>
      <Box m="2rem 5rem">
        ...
        <p>Effective date: 2022-01-20</p>
        <p>
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b> MovieFreak</b>.
        </p>
        <p>
          <b>MovieFreak</b> (“us”, “we”, or “our”) operates{" "}
          <b>MovieFreak.com</b> (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>MovieFreak.com</b>, and
        ...
        <p>
          <b>SERVICE</b> means the MovieFreak.com website operated by
          MovieFreak.
        </p>
        <p>
        ...
        <p>MovieFreak uses the collected data for various purposes:</p>
        ...
        <p>
          If you are located outside Serbia and choose to provide information to
          us, please note that we transfer the data, including Personal Data, to
          Serbia and process it there.
        </p>
        <p>
        ...
        <p>
          MovieFreak will take all the steps reasonably necessary to ensure that
        ...
        <p>
          ...
          us at <b>support@moviefreak.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>support@moviefreak.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>support@moviefreak.com</b>.
        </p>
        <p mt="5em" size="sm">
          This{" "}
          <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
          was created for <b>MovieFreak.com</b> by{" "}
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-01-20.
        </p>
      </Box>
    </Layout>
  );
